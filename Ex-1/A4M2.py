...
class PKS:
    ...
    def Cstep(self, X, Cv, t0):
        ...
        rho = rho.at[u1, u2, u3].add((1 - v1) * (1 - v2) * (1 - v3))
        rho = rho.at[u1 + 1, u2, u3].add(v1 * (1 - v2) * (1 - v3))
        rho = rho.at[u1, u2 + 1, u3].add((1 - v1) * v2 * (1 - v3))
        rho = rho.at[u1, u2, u3 + 1].add((1 - v1) * (1 - v2) * v3)
        rho = rho.at[u1 + 1, u2 + 1, u3].add(v1 * v2 * (1 - v3))
        rho = rho.at[u1 + 1, u2, u3 + 1].add(v1 * (1 - v2) * v3)
        rho = rho.at[u1, u2 + 1, u3 + 1].add((1 - v1) * v2 * v3)
        rho = rho.at[u1 + 1, u2 + 1, u3 + 1].add(v1 * v2 * v3)
