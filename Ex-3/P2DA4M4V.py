...
class PKS:
    def __init__(self,M0=25,H=256,L=8,k=1e-2,eps=1e-5,reg=0,chi=1,mu=1,rng_key=random.PRNGKey(216)):
    ...
    def solve(self,t,t0,show_num=5,show_flag=True,notebook_name="simulation"):
        ...
        self.FK = - 1 / ((4*(jnp.pi**2)/(self.L**2)) * ((u1-self.offset)**2+(u2-self.offset)**2) + self.b2)
    ...
    def Xstep(self, X, Cv, t0, key):
        ...
        gradx += (grad0[u1, u2] * (1 - v1) * (1 - v2) * (1 + v1/2 + v2/2 - v1*v1/2 - v2*v2/2))
        gradx += (grad0[u1 + 1, u2] * v1 * (1 - v2) * (1 + v1/2 + v2/2 - v1*v1/2 - v2*v2/2))
        gradx += (grad0[u1, u2 + 1] * (1 - v1) * v2 * (1 + v1/2 + v2/2 - v1*v1/2 - v2*v2/2))
        gradx += (grad0[u1 + 1, u2 + 1] * v1 * v2 * (1 + v1/2 + v2/2 - v1*v1/2 - v2*v2/2))

        gradx += grad0[u1 - 1, u2] * (- (1 - v1) * (1 - v2) * v1 * (2 - v1) / 6)
        gradx += grad0[u1 + 2, u2] * (- (1 - v1) * (1 - v2) * v1 * (1 + v1) / 6)
        gradx += grad0[u1 - 1, u2 + 1] * (- (1 - v1) * v2 * v1 * (2 - v1) / 6)
        gradx += grad0[u1 + 2, u2 + 1] * (- (1 - v1) * v2 * v1 * (1 + v1) / 6)
        
        gradx += grad0[u1, u2 - 1] * (- (1 - v1) * (1 - v2) * v2 * (2 - v2) / 6)
        gradx += grad0[u1, u2 + 2] * (- (1 - v1) * (1 - v2) * v2 * (1 + v2) / 6)
        gradx += grad0[u1 + 1, u2 - 1] * (- v1 * (1 - v2) * v2 * (2 - v2) / 6)
        gradx += grad0[u1 + 1, u2 + 2] * (- v1 * (1 - v2) * v2 * (1 + v2) / 6)
